...
{
    public class MistralSuggestionService : ExternalServiceBase<SuggestionRequest, SuggestionResponse>, ISuggestionService
    {
        private const string _endpoint = "https://api.mistral.ai/v1/chat/completions";
        ...
        public MistralSuggestionService(IConfiguration configuration, ILogger<SuggestionService> logger) : base(logger, configuration["Services:Mistral:ApiKey"] ?? "")
        {
            _logger = logger;
        }
